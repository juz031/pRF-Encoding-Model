...
def calculate_r2(predicted_neural, true_neural, roi_masks, noise_ceiling, args):
    ...
    for area in areas:
        ...
        save_root = f'/home/junruz/prf_model/figure/CCN/S{args.subject_id[0]}/{area}'
        ...
        save_path = os.path.join(save_folder, f'{area}_{args.layer_name}_nc_{noise_ceiling_threshold}_r2.pdf')
        ...
        os.makedirs(save_folder, exist_ok=True)
        save_path = os.path.join(save_folder, f'{area}_{args.layer_name}_nc_{noise_ceiling_threshold}_r2_nc.pdf')
