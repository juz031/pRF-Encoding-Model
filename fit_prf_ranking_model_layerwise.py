...
def model_fitting(voxel_data, train_ids, val_ids, nest_ids, features, args, device):
    """
    Return:
    ...
    return best_weights_dict, channel_kept_dict, best_lambda_array, best_nest_loss_array
...
def calculate_r2(predicted_neural, true_neural, roi_masks, noise_ceiling, args):
    ...
    for area in areas:
        ...
        save_root = f'/home/junruz/prf_model/figure/no_zscore_drop/S{args.subject_id[0]}/{area}'
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/user_data/junruz/prf_models/no_zscore_drop/S1/RN50')
